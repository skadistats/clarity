...
public class TraceMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        var outDir = Path.of("bench-results", "trace_" + timestamp + "_" + branchSha);
        Files.createDirectories(outDir);

        var jsonPath = outDir.resolve("results.json");
        var opts = new OptionsBuilder()
            .include(MutationTraceBench.class.getSimpleName())
        ...
        System.out.println("Running mutation-trace benchmark, results will be written to " + outDir.toAbsolutePath());
