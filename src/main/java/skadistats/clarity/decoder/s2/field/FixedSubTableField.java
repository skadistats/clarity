...
public class FixedSubTableField extends Field {
    ...
    public void accumulateName(S2FieldPath fp, int pos, List<String> parts) {
        ...
        if (fp.last() > pos) {
            fieldProperties.getSerializer().accumulateName(fp, pos + 1, parts);
        }
    }
    ...
    public Unpacker getUnpackerForFieldPath(S2FieldPath fp, int pos) {
        ...
        if (fp.last() == pos) {
            ...
            return fieldProperties.getSerializer().getUnpackerForFieldPath(fp, pos + 1);
        }
    }
    ...
    public Field getFieldForFieldPath(S2FieldPath fp, int pos) {
        ...
        if (fp.last() == pos) {
            ...
            return fieldProperties.getSerializer().getFieldForFieldPath(fp, pos + 1);
        }
    }
    ...
    public FieldType getTypeForFieldPath(S2FieldPath fp, int pos) {
        ...
        if (fp.last() == pos) {
            ...
            return fieldProperties.getSerializer().getTypeForFieldPath(fp, pos + 1);
        }
    }
    ...
    public Object getValueForFieldPath(S2FieldPath fp, int pos, ArrayEntityState state) {
        ...
        if (fp.last() == pos) {
            ...
            return fieldProperties.getSerializer().getValueForFieldPath(fp, pos + 1, state.sub(i));
        } else {
            return null;
        }
    }
    ...
    public void setValueForFieldPath(S2FieldPath fp, int pos, ArrayEntityState state, Object value) {
        ...
        if (fp.last() == pos) {
            ...
            fieldProperties.getSerializer().setValueForFieldPath(fp, pos + 1, state.sub(i), value);
        }
    }

    @Override
    public S2FieldPath getFieldPathForName(S2ModifiableFieldPath fp, String property) {
        return fieldProperties.getSerializer().getFieldPathForName(fp, property);
    }
    ...
    public void collectFieldPaths(S2ModifiableFieldPath fp, List<FieldPath> entries, ArrayEntityState state) {
        ...
        if (state.has(i)) {
            fp.down();
            fieldProperties.getSerializer().collectFieldPaths(fp, entries, state.sub(i));
            fp.up(1);
        }
    }
