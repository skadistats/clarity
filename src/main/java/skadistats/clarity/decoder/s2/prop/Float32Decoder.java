...
public class Float32Decoder implements FieldDecoder<Float> {
    ...
    public Float decode(BitStream bs, Field f) {
        ...
        if ((flags & 0x100) != 0) {
            ...
            int bc = f.getBitCount() != null ? f.getBitCount() : 8; // assume 8, dunno if right, makes m_hOwnerEntity in CWorld baseline look correct ...
