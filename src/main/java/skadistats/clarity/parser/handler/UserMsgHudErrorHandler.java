...
@RegisterHandler(CDOTAUserMsg_HudError.class)
public class UserMsgHudErrorHandler implements Handler<CDOTAUserMsg_HudError> {

    private final Logger log = LoggerFactory.getLogger(getClass());
    
    @Override
    public void apply(int peekTick, CDOTAUserMsg_HudError message, Match match) {
        HandlerHelper.traceMessage(log, peekTick, message);
        log.debug("{} HUD_ERROR [type={}]",
