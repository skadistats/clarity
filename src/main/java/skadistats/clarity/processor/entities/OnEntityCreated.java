...
public @interface OnEntityCreated {
    ...
    final class Event extends skadistats.clarity.event.Event<OnEntityCreated> {
        private final Listener[] typedListeners;
        private final Filter[] typedFilters;

        public Event(Runner runner, Class<OnEntityCreated> eventType, Set<EventListener<OnEntityCreated>> listeners) {
