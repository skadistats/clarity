...
public @interface OnEntityDeleted {
    ...
    final class Event extends skadistats.clarity.event.Event<OnEntityDeleted> {
        private final Listener[] typedListeners;
        private final Filter[] typedFilters;

        public Event(Runner runner, Class<OnEntityDeleted> eventType, Set<EventListener<OnEntityDeleted>> listeners) {
