...
public @interface OnEntityLeft {
    ...
    final class Event extends skadistats.clarity.event.Event<OnEntityLeft> {
        private final Listener[] typedListeners;
        private final Filter[] typedFilters;

        public Event(Runner runner, Class<OnEntityLeft> eventType, Set<EventListener<OnEntityLeft>> listeners) {
