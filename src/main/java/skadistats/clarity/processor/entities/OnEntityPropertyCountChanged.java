...
public @interface OnEntityPropertyCountChanged {
    ...
    final class Event extends skadistats.clarity.event.Event<OnEntityPropertyCountChanged> {
        private final Listener[] typedListeners;
        private final Filter[] typedFilters;

        public Event(Runner runner, Class<OnEntityPropertyCountChanged> eventType, Set<EventListener<OnEntityPropertyCountChanged>> listeners) {
