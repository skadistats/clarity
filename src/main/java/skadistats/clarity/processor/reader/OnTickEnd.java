...
public @interface OnTickEnd {
    ...
    final class Event extends skadistats.clarity.event.Event<OnTickEnd> {
        private final Listener[] typedListeners;

        public Event(Runner runner, Class<OnTickEnd> eventType, Set<EventListener<OnTickEnd>> listeners) {
