...
public @interface OnStringTableClear {
    ...
    final class Event extends skadistats.clarity.event.Event<OnStringTableClear> {
        private final Listener[] typedListeners;

        public Event(Runner runner, Class<OnStringTableClear> eventType, Set<EventListener<OnStringTableClear>> listeners) {
