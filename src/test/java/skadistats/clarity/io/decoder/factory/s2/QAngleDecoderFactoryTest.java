...
public class QAngleDecoderFactoryTest {
    ...
    public void precise32BitResolvesToNoScaleDecoder() {
        var decoder = S2DecoderFactory.createDecoder(props("qangle_precise", 32), "QAngle").getDecoder();
        assertTrue(
    ...
    public void precise32BitReadsThreeFullFloats() {
        ...
        var decoded = (Vector) S2DecoderFactory.createDecoder(props("qangle_precise", 32), "QAngle").getDecoder().decode(bs);
    ...
    public void preciseWithoutBitCountStillUsesPreciseDecoder() {
        var decoder = S2DecoderFactory.createDecoder(props("qangle_precise", 0), "QAngle").getDecoder();
        assertTrue(
    ...
    private static DecoderProperties props(String encoderType, int bitCount) {
